...
<html>
    ...
    <body>
        ...
        <div id="clip" class="sidenav">
            <form id="form" onload="openClip(form)" action="Contact.php" method="post">
                ...
                <select>
                    <option selected="selected" disabled="disabled">Select your birth country....</option>
                ...
                <button name="submit" type="submit" value="Submit" class="button button-block">Submit</button>
